...
import argparse
import os
from pt2_llm.eval_utils import load_model_and_tokenizer, add_common_args
...
def get_ppl_eval_loaders(name, tokenizer, seqlen=2048):
    if "wikitext2" in name:
        ...
        # train = load_from_disk('/data2/user/jackyan/dataset/llm/wikitext/traindata')
        
        # testdata = load_from_disk('/data2/user/jackyan/dataset/llm/wikitext/testdata')
        testdata = load_from_disk('/data2/user/jackyan/dataset/llm/wikitext/testdata')

        # testdata = load_from_disk('/home/bml/storage/mnt/v-c615a05aea3047cd/org/users/yanxianglong/dataset/llm/wikitext/testdata')
        ...
        # valdata = load_from_disk('/data2/user/jackyan/dataset/llm/c4/valdata')
        ...
        # traindata = load_from_disk('/home/bml/storage/mnt/v-c615a05aea3047cd/org/users/yanxianglong/dataset/llm/ptb/traindata')
        # testdata = load_from_disk('/home/bml/storage/mnt/v-c615a05aea3047cd/org/users/yanxianglong/dataset/llm/ptb/testdata')

        # traindata = load_from_disk('/data2/user/jackyan/dataset/llm/ptb/traindata')
        # testdata = load_from_disk('/data2/user/jackyan/dataset/llm/ptb/testdata')
...
def get_ppl_eval_loaders_original(name, tokenizer, seqlen=2048):
    if "wikitext2" in name:
        testdata = load_dataset(
            "wikitext",
            "wikitext-2-raw-v1",
...
if __name__ == '__main__':
    ...
    parser.add_argument('--fp', action='store_true', help='Use full precision (fp). Default is False.')
