...
| CEGSP-P8-A | P8-A | 下游连续分数筛查 | BF16 / affine ternary / affine+CEGSP | Llama-2-7B + Qwen3-8B; HS/PIQA/ARC-E/ARC-C/WG/MMLU screen | normalized choice LL, accuracy, margin | MUST | PREPARED_ON_42079_AWAITING_HUMAN_LAUNCH |
