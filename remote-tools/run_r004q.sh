...
run_id=R004Q
command_text='./venv/bin/python quantize.py /root/PT2-LLM/qwen3-8b wikitext2 ternary-init --nsamples 8 --calib_seqlen 512 --ppl_seqlen 2048 --blocksize 128 --device cuda:0'
...
OMP_NUM_THREADS=8 MKL_NUM_THREADS=8 OPENBLAS_NUM_THREADS=8 PT2_DATA_ROOT=/root/PT2-LLM/data \
  ./venv/bin/python quantize.py /root/PT2-LLM/qwen3-8b wikitext2 ternary-init \
    --nsamples 8 --calib_seqlen 512 --ppl_seqlen 2048 --blocksize 128 --device cuda:0 \
